...
namespace Apical.TaskManagement.Api.Middleware.Logging;
...
public static class LoggingServiceFactory
{
    public static IServiceCollection AddCustomizedLogging(this IServiceCollection sc)
    {
        ...
        sc.AddSingleton<Serilog.ILogger>(serilog);
        sc.AddSingleton(msLoggerFactory).AddSingleton(msLoggerFactory.CreateLogger("Apical.TaskManagement"));
